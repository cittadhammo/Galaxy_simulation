...
public:
	 ...
	 */
	static dim::Vector3 random_sphere(const SimulationConfig& config);

	/**
	 * @brief Initializes star positions and matter types.
	 * 
	 */
	static void initialize_star_types_and_positions(
	 ...
	 */
	static void create_galaxy(int i, const SimulationConfig& config, SimulationState& state);
	 ...
	 * @param i the index of the star
	 */
	static void create_collision(int i, const SimulationConfig& config, SimulationState& state);
	 ...
	 */
	static void create_universe(int i, const SimulationConfig& config, SimulationState& state);

	/**
	 * @brief Initialize the computer.
	 */
	static void init(const SimulationConfig& config, SimulationState& state);

	/**
	 * @brief Does the simulation computations of the current frame.
	 */
	static void compute(const SimulationConfig& config, SimulationState& state);
};
